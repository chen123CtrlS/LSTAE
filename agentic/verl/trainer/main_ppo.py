...
import os
os.environ["JAVA_HOME"] = "/opt/conda/envs/verl-agent-webshop/lib/jvm"
...
from verl.trainer.ppo.ray_trainer import RayPPOTrainer,RayPPOTrainer1
...
class TaskRunner:
    def run(self, config):
        ...
        if config.trainer.spo.enable:
            trainer = RayPPOTrainer1(
            config=config,
            tokenizer=tokenizer,
            processor=processor,
